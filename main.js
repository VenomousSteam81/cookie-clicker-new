...
Game.Launch=function()
{
	...
	'<div class="listing">Modded Cookie Clicker by VenomousSteam81</div>'+
		...
		*/
		...
		Game.CalculateGains=function()
		{
			...
			if (Game.hasGod)
			{
				...
				if (godLvl==1) mult*=1.25;
				else if (godLvl==2) mult*=2.50;
				else if (godLvl==3) mult*=3.99;
			}
		...
		Game.last.minigameUrl='dungeons.js'; //not working yet...
